...
# $Header: sys-boot/mkinitramfs-ll/mkinitramfs-ll-9999.ebuild v1.2 2012/05/23 17:15:12 -tclover Exp $
...
src_install() {
	...
	if use sqfsd; then
		...
		mv sqfsdsvc/README.textile sqfsdsvc/README.sqfsdsvc.textile || die
