@$Id: bar-overlay/README.textile, 2012/09/18 07:35:10 -tclover Exp $@
...
@% layman -o https://raw.github.com/tokiclover/bar-overlay/master/overlay.xml -f -a bar@
...
@% wget https://raw.github.com/tokiclover/bar-overlay/master/overlay.xml@
@% layman -a bar@
