...
# $Header: dev-python/python-efl/python-efl-1.12.0.ebuild,v 1.2 2015/06/08 -tclover Exp $
...
case "${PV}" in
	...
	SRC_URI="https://download.enlightenment.org/rel/bindings/python/${PN}/${P/_/-}.tar.bz2"
	;;
esac
