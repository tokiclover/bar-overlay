...
# $Header: www-misc/browser-home-profile/browser-home-profile-3.0.ebuild,v 1.2 2016/03/09 12:53:34 Exp $
...
src_install()
{
	...
	emake PREFIX=/usr DESTDIR="${ED}" install$(usex perl '-perl' "$(usex python '-python' '')" )
}
