...
# $Header: media-video/ffmpeg/ffmpeg-2.6.9999.ebuild,v 1.5 2016/02/18 10:01:57 Exp $
...
MIPS_CPU_FEATURES=(dspr1:mipsdspr1 dspr2:mipsdspr2 fpu:mipsfpu)
PPC_CPU_FEATURES=(altivec:altivec vsx:vsx)
X86_CPU_FEATURES=(
