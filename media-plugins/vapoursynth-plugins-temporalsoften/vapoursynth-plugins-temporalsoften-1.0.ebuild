...
# $Header: media-plugins/vapoursynth[${MULTILIB_USEDEP}]-plugins-temporalsoften/vapoursynth-plugins-temporalsoften-9999.ebuild,v 1.1 2015/09/24 Exp $
