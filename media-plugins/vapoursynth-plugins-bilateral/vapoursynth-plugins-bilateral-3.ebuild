...
# $Header: media-plugins/vapoursynth-plugins-bilateral/vapoursynth-plugins-bilateral-9999.ebuild,v 1.2 2015/10/01 Exp $

EAPI=5

MY_PN="VapourSynth-Bilateral"
case "${PV}" in
	(9999*)
		KEYWORDS=""
		VCS_ECLASS=git-2
...
DESCRIPTION="Bilateral and Gaussian filter plugin for VapourSynth"
