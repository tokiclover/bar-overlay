...
# $Header: media-plugins/vapoursynth-plugins-sangnommod/vapoursynth-plugins-sangnommod-9999.ebuild,v 1.2 2016/05/12 Exp $
...
case "${PV}" in
	...
	(*)
		...
		SRC_URI="https://github.com/HomeOfVapourSynthEvolution/${MY_PN}/archive/v${PV%_*}-fix.tar.gz -> ${P}.tar.gz"
