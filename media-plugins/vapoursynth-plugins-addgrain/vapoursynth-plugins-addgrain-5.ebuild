...
# $Header: media-plugins/vapoursynth-plugins-addgrain/vapoursynth-plugins-addgrain-9999.ebuild,v 1.2 2015/10/01 Exp $

EAPI=5

MY_PN="VapourSynth-AddGrain"
case "${PV}" in
	(9999*)
		KEYWORDS=""
		VCS_ECLASS=git-2
...
DESCRIPTION="AddGrain plugin for VapourSynth ported from Avisynth"
