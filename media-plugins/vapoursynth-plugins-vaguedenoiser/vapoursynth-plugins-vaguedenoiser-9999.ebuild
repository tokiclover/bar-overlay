...
# $Header: media-plugins/vapoursynth-plugins-vaguedenoiser/vapoursynth-plugins-vaguedenoiser-9999.ebuild,v 1.2 2015/10/01 Exp $

EAPI=5

MY_PN="VapourSynth-VagueDenoiser"
case "${PV}" in
	(9999*)
		KEYWORDS=""
		VCS_ECLASS=git-2
...
DESCRIPTION="VagueDenoiser plugin for VapourSynth ported from Avisynth"
