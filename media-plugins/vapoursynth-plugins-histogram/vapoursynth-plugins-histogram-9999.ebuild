...
# $Header: media-plugins/vapoursynth-plugins-histogram/vapoursynth-plugins-histogram-9999.ebuild,v 1.2 2015/10/01 Exp $
...
DESCRIPTION="Histogram plugin for VapourSynth ported from Avisynth"
