...
# $Header: media-plugins/vapoursynth-plugins-retinex/vapoursynth-plugins-retinex-9999.ebuild,v 1.2 2015/10/01 Exp $

EAPI=5

MY_PN="VapourSynth-Retinex"
case "${PV}" in
	(9999*)
		KEYWORDS=""
		VCS_ECLASS=git-2
...
DESCRIPTION="Retinex algorithm plugin for VapourSynth"
