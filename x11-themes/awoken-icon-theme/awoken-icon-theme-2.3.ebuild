...
# $Header: bar-overlay/x11-themes/awoken-icon-theme/awoken-icon-theme-2.3.ebuild,v 1.1 2012/07/04 00:21:45 -tclover Exp $
...
src_prepare() {
	for theme in ${MY_PN}{,Dark,White}; do unpack ./$theme.tar.gz || die "eek!"; done
	local res x
