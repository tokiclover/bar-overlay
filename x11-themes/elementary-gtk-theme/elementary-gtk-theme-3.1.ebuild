...
# $Header: $BAR-overlay/x11-themes/elementary-gtk-theme-2.1.ebuild,v 1.1 2012/05/04 -tclover Exp $
...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="gnome gtk gtk3 minimal shell xfwm4"
EAPI=2
...
src_install() {
	...
	use shell && mv Elementary-3.2/gnome-shell ${pn} || die
