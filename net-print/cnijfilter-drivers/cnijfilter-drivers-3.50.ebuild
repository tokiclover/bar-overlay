...
# $Header: net-print/cnijfilter-drivers/cnijfilter-drivers-3.50.ebuild,v 2.0 2014/08/04 03:10:53 -tclover Exp $
...
PATCHES=(
	"${FILESDIR}"/${MY_PN}-${PV/50/20}-4-cups_ppd.patch
	"${FILESDIR}"/${MY_PN}-${PV/50/20}-4-libpng15.patch
)
