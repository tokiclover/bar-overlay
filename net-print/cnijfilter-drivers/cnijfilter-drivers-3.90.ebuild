...
# $Header: net-print/cnijfilter-drivers/cnijfilter-drivers-3.90.ebuild,v 1.9 2014/08/02 03:10:53 -tclover Exp $
...
PATCHES=(
	"${FILESDIR}"/${MY_PN}-${PV/90/20}-4-cups_ppd.patch
	"${FILESDIR}"/${MY_PN}-${PV/90/20}-4-libpng15.patch
)
