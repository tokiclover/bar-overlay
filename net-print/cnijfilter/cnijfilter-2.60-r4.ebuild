...
# $Header: bar-overlay/net-print/cnijfilter/cnijfilter-2.60-r4.ebuild,v 1.7 2012/07/04 00:21:04 -tclover Exp $
...
pkg_setup() {
	...
	use gtk && SRC+=" cngpijmon" PRSRC+=" stsmon"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P%-r*}-1-pstocanonij.patch || die
	epatch "${FILESDIR}"/${P%-r*}-1-canonip4200.ppd.patch.bz2 || die
