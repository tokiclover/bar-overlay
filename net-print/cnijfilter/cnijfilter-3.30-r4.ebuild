...
# $Header: bar-overlay/net-print/cnijfilter/cnijfilter-3.30-r4.ebuild,v 1.6 2012/06/01 01:27:08 -tclover Exp $
...
SLOT="3.30"
KEYWORDS="~x86 ~amd64"
IUSE="+debug amd64 scanner servicetools net gtk +usb ip2700 mx340 mx350 mx870"
REQUIRED_USE="servicetools? ( gtk ) scanner? ( gtk net ) ip2700? ( !scanner )"
...
_pruse=("ip2700" "mx340" "mx350" "mx870")
_prname=(${_pruse[@]})
_prid=("364" "365" "366" "367")
_prcomp=("ip2700series" "mx340series" "mx350series" "mx870series")
_max=$((${#_pruse[@]}-1))
...
pkg_setup() {
	...
	use scanner && _scansrc="../scangearmp-source-1.50-1" _src+=" ${_scansrc}/scangearmp"
