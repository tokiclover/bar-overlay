...
ECNIJ_PRUSE=( "mp430" "mg2200" "e510" "mg3200" "mg4200" "ip7200" "mg5400" "mg6300" )
ECNIJ_PRID=( "401" "402" "403" "405" "406" "407" "408" )
...
PATCHES=(
	"${FILESDIR}"/${PN}-${PV/80/20}-4-cups_ppd.patch
	"${FILESDIR}"/${PN}-${PV/80/20}-4-libpng15.patch
)
