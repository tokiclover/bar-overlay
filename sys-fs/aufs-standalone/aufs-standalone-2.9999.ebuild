...
# $Header: sys-fs/aufs-standalone/aufs-standalone-2.9999.ebuild v1.5 2012/05/24 00:46:03 -tclover Exp $
...
pkg_setup() {
	...
	kernel_is ge 3 0 0 && die "kernel too new"
	...
	if ! ( patch -p1 --dry-run --force -R -d ${KV_DIR} \
		...
		if use kernel-patch; then
			...
			epatch "${FILESDIR}"/aufs-{base,standalone}-${version}.patch
