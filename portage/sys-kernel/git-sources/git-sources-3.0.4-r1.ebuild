...
# $Header: $BAR-overlay/portage/sys-kernel/git-sources/git-sources-3.0.4-r1.ebuild, v1.1 2011/08/30 -tclover Exp $
...
EGIT_COMMIT=04aa37b5f943920017ad094e776cd5514b1a9246
EGIT_TAG=v${PV/-r[0-9]*}
EGIT_PROJECT=${PN}
EGIT_NOUNPACK="yes"
...
src_unpack() {
	git-2_src_unpack
	kernel_is gt 3 0 4 && EGIT_BRANCH=aufs${KV_MAJOR}.x-rcN || EGIT_BRANCH=aufs${KV_MAJOR}.${KV_MINOR:-0}
	unset EGIT_COMMIT
	unset EGIT_TAG
