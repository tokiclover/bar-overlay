...
# $Header: $BAR-overlay/x11-base/nouveau-drm-20111101.ebuild,v 1.1 2011/11/01 -tclover Exp $
...
CONFIG_CHECK="~ACPI_VIDEO ~BACKLIGHT_CLASS_DEVICE ~DEBUG_FS ~FB_CFB_FILLRECT ~FB_CFB_COPYAREA ~FB_CFB_IMAGEBLIT ~FRAMEBUFFER_CONSOLE ~I2C_ALGOBIT ~MXM_WMI ~VGA_ARB"
