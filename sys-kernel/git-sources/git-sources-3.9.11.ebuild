...
# $Header: sys-kernel/git-sources/git-sources-3.9.11.ebuild,v 1.6 2013/07/26 12:10:43 -tclover Exp $
...
uksm_src=uksm-0.1.2.2-for-v${okv}.ge.1.patch
...
#		pushd "${WORKDIR}" && epatch "${FILESDIR}"/${bfs_src}.patch && popd
	...
	use bld && epatch "${WORKDIR}"/bld-${okv}-rc4/BLD-${okv}-rc4.patch
