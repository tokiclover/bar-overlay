...
# $Header: bar-overlay/sys-kernel/git-sources/git-sources-3.0.34.ebuild,v 1.2 2012/06/14 11:53:38 -tclover Exp $
...
ck_uri="http://ck.kolivas.org/patches/${okv:0:1}.0/${okv}/${okv}.0-ck1/"
...
src_prepare() {
	...
	if use ck; then
		...
		for pch in $(< ../patches/series); do epatch ../patches/$pch || die; done
	fi
