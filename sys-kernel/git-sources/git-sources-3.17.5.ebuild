...
# $Header: sys-kernel/git-sources/git-sources-3.17.5.ebuild,v 2.0 2014/12/04 13:45:34 -tclover Exp $
...
IUSE="aufs bfs bfq ck deblob fbcondecor +gentoo hardened +optimization reiser4"
