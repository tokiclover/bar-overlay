...
# $Header: sys-kernel/git-sources/git-sources-3.15.5.ebuild,v 2.0 2014/07/14 12:45:34 -tclover Exp $
...
IUSE="aufs bfs bfq ck deblob fbcondecor +gentoo hardened toi uksm"
