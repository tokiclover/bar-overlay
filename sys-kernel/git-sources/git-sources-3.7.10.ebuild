...
# $Header: bar/sys-kernel/git-sources/git-sources-3.7.10.ebuild,v 1.5 2013/06/06 16:32:42 -tclover Exp $
...
uksm_src=uksm-0.1.2.2-for-v${okv}.ge.10.patch
...
src_prepare() {
	if use aufs; then
		for file in Documentation fs; do
